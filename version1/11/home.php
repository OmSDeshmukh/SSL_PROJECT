...
<?php
    ...
    //creating database for annoucements : 
    $sql = "CREATE DATABASE IF NOT EXISTS announcements";
    ...
    //connecting to database of annoucements : 
    $conn = new mysqli("localhost" , "root" , "" , "announcements");
    if(!($conn->error)){
        echo"Connected to database of announcements succesfully !<br>";
    }
    ...
    if($conn->query($sql) === TRUE){
        echo"Created table for results successfully !<br>";
    }
    else{
        echo"Some error in creating table of admins";
    }

    //creating database for admin data : 
    $conn = new mysqli("localhost" , "root" , "");
