...
<body>
    <div class="admin">
        ...
        <a href="addadmin.php"><input class = "button" value="Add Another Admin" type="submit"></a>
        <a href="removeadmin.php"><input class = "button" value="Remove Admin" type="submit"></a>
    </div>
</body>
</html>